      ...
      <div>
        ...
        <div className="container">
          <CSSTransitionGroup
            ...
            {
              this.props.active === 0
              ? <CreatePerson key="create" newPerson={this.props.newPerson} addPerson={this.props.addPerson} />
              : <SearchPerson key="search" searchPerson={this.props.searchPerson} searchedPerson={this.props.searchedPerson} />
            }
          </CSSTransitionGroup>
        </div>
      </div>
